//Adapted from https://pastebin.com/grL2nccg by Minions Art

void LitToon_float(in float3 Normal, in float Smoothness, in float3 ClipSpacePos, in float3 WorldPos, in float4 ToonRampTinting,
    in float ToonRampOffset, out float3 ToonRampOutput, out float3 Direction)
{
        ...
        half toonRamp = smoothstep(ToonRampOffset, ToonRampOffset+ Smoothness, d );
